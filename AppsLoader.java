    ...
    public ArrayList<AppModel> loadInBackground() {
        ...
        for (int i = 0; i < apps.size(); i++) {
            ...
            if (context.getPackageManager().getLaunchIntentForPackage(pkg) != null) {
               ...
               /* if(!( (app.getLabel().contains("Album")) ||
                        (app.getLabel().contains("ES File Explorer")) ||
                        (app.getLabel().contains("File Commander")) ||
                        (app.getLabel().contains("SHAREit")) ||
                        (app.getLabel().contains("IPE Browser")))){
                    items.add(app);
                }*/
                ...
                if (prefs.getBoolean("Folder",false)){
                    ...
                    if (!utilities.isBlocked(app.getLabel())){
                        items.add(app);
                    }
                }else {
                    items.add(app);
